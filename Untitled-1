        ...
        return (
            ...
            <section>
                <div className="isHidden isVisible--medium">
                    ...
                    <div className="box explore vr">
                        <div className="wrapper vr--x2">
                        <h1 className="txt txt--weight-semibold vr txt--color-white">Download the Key Collector Comics App and become a Superpowered Collector</h1>
