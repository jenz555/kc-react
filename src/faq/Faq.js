...
const mailto = '"mailto:nick@keycollectorcomics.com?subject=Key%20Collector%20Comics%20"';

const answers = [
`Key Collector Comics mobile app is available for download in the Apple iTunes store and Google Play store for Android or clicking on the Apple and Google option on <strong>${jen} landing page<strong>. We hope you download the app and let us know your thoughts.`,
`Please email nick@keycollectorcomics.com or send feedback through the app (accessed by tapping "Account")`,
`Key Collector Comics is available free of charge on your Apple iPhone through Apple iTunes or your Android phone downloadable in the  Google Play store. We sincerely hope you like the app and would love your feedback.  Please email nick@keycollectorcomics.com or send feedback through the app (accessed by tapping "Account")`,
`The Key Collector Comics database is the result of 2,500 hours of cross-referencing nearly 100 different sources from the actual comic books that contain these key issue instances to researching the history of the comic book medium in libraries and online. `,
`Key Collector Comics mobile app utilizes data found on the web pertaining to recent sales of raw comics over a 365 day period. The Key Collector Comics price guide is meant to be used only as a suggested entertainment resource and cannot be held accountable for comic book transactions. With the legalities out of the way, we encourage you to let us know if you see a price that is far off its mark.  Please contact us: email nick@keycollectorcomics.com or send feedback through the app (accessed by tapping "Account")`,
`We will not allow our database to be copied in any way or used elsewhere for profit or non-profit.  Key Collector Comics database is officially copyrighted by the U.S. government copyright office.  `,
`We would greatly appreciate you dropping us a note and letting us know. There are multiple ways to contact us.  Email: nick@keycollectorcomics.com  Submit feedback in the app: Tap "Account" then tap "Send Feedback" and follow the instructions.  You can also reach us on social media: Instagram @keycollectorcomics or facebook.com/keycollector or Twitter @key_collect`,
`Key Collector Comics mobile app offers three ways to search for key issues. "Search by Title" if you are flipping through many comics in a series and want to know which issues are of value or contain a significant event. "Search by Character" to view a chronological timeline of a hero or villain's history starting from his or her 1st appearance`,
`We encourage any and all constructive criticism, ideas, praise and any other communication from the comic book community.  Please reach out to nick@keycollectorcomics.com or send feedback through the app (accessed by tapping "Account") and let's brainstorm some ideas together.  Key Collector Comics was created by comic book collectors FOR comic book collectors so it is as much yours as it is ours.`,
`Key Collector Comics' database is comprised of many types of key issues to suit an array of collector's interests.  Some examples are: superhero 1st appearances and other milestones, iconic cover art, writer and artist industry debuts, comics of historical significance, World War II stories and art, recalled issues, scarce issues, golden age issues, controversial comics and many other categories are organized in such a way to help personalize your experience.  Currently there are filters available to minimize the time frame of your search by comic book Age (i.e., Golden Age, Silver Age etc.). We plan to add more filters to help consolidate your experience to what you want to see and would love your input on suggestions.  Please email nick@keycollectorcomics.com and we'll start a discussion.`,
`Absolutely! The Key Collector Comics database is a labor of over 18 months and 2,500 hours with a lot of effort made to cross-reference each entry to get you the most accurate information that's available anywhere in the world. With that being said, it is quite possible we've missed a few issues.  Please email nick@keycollectorcomics.com or send feedback through the app (accessed by tapping "Account"). We'll give you a shoutout for the assist on our social media: Instagram @keycollectorcomics  Facebook.com/keycollector  Twitter @key_collect`,
];
const listItemsAnswers = answers.map((answer) =>
  <li>{answer}</li>
);
  ...
  render() {
    return (
      ...
      <div className="wrapper vr--x2">
        ...
        <p>
        Key Collector Comics mobile app is available for download in the <a href="">Apple iTunes store</a> and <a href="">Google Play store</a> for Android or clicking on the Apple and Google option on keycollectorcomics.com landing page.  We hope you download the app and let us know your thoughts. Please email <a href="mailto:nick@keycollectorcomics.com?subject=Key%20Collector%20Comics%20">nick@keycollectorcomics.com</a> or send feedback through the app (accessed by tapping "Account")
        </p>
      </Collapsible>

      <Collapsible trigger={questions[1]}>
      <p>
      Key Collector Comics is available free of charge on your Apple iPhone through <a href="">Apple iTunes</a> or your Android phone downloadable in the <a href="">Google Play store</a>. We sincerely hope you like the app and would love your feedback. Please email <a href="mailto:nick@keycollectorcomics.com?subject=Key%20Collector%20Comics%20">nick@keycollectorcomics.com</a> or send feedback through the app (accessed by tapping "Account")
      </p>
    </Collapsible>
